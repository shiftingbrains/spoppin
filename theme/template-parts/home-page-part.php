			...
			<div class="container pb-14 pb-md-16 mb-lg-22 mb-xl-24">
				<div class="row gx-0 mb-16 mb-mb-20">
					<div class="col-9 col-sm-10 col-lg-9 mx-auto mt-n15 mt-md-n20" data-cues data-group="images" data-delay="1500">
						<img class="img-fluid mx-auto rounded shadow-lg" data-cue="slideInUp" src="src/img/photos/sa1.jpg" srcset="src/img/photos/sa1@2x.jpg 2x" alt="" />
						<img class="position-absolute rounded shadow-lg" data-cue="slideInRight" src="src/img/photos/sa2.jpg" srcset="src/img/photos/sa2@2x.jpg 2x" style="top: 20%; right:-10%; max-width:30%; height: auto;" alt="" />
						<img class="position-absolute rounded shadow-lg" data-cue="slideInLeft" src="src/img/photos/sa3.jpg" srcset="src/img/photos/sa3@2x.jpg 2x" style="top: 10%; left:-10%; max-width:30%; height: auto;" alt="" />
						<img class="position-absolute rounded shadow-lg" data-cue="slideInLeft" src="src/img/photos/sa4.jpg" srcset="src/img/photos/sa4@2x.jpg 2x" style="bottom: 10%; left:-13%; max-width:30%; height: auto;" alt="" />
					</div>
					<!-- /column -->
				</div>
				<!-- /.row -->
				<div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center mb-14 mb-md-18">
					<div class="col-lg-6 position-relative">
						...
						<div class="row gx-md-5 gy-5 position-relative">
							<div class="col-6">
								<img class="img-fluid rounded shadow-lg mb-5" data-cue="fadeIn" data-delay="300" src="src/img/photos/sa5.jpg" srcset="src/img/photos/sa5@2x.jpg 2x" alt="" />
								<img class="img-fluid rounded shadow-lg d-flex col-10 ms-auto" data-cue="fadeIn" data-delay="600" src="src/img/photos/sa6.jpg" srcset="src/img/photos/sa6@2x.jpg 2x" alt="" />
							</div>
							<!-- /column -->
							<div class="col-6">
								<img class="img-fluid rounded shadow-lg my-5" data-cue="fadeIn" data-delay="900" src="src/img/photos/sa7.jpg" srcset="src/img/photos/sa7@2x.jpg 2x" alt="" />
								<img class="img-fluid rounded shadow-lg d-flex col-10" data-cue="fadeIn" data-delay="1200" src="src/img/photos/sa8.jpg" srcset="src/img/photos/sa8@2x.jpg 2x" alt="" />
							</div>
							<!-- /column -->
						</div>
						<!-- /.row -->
				...
				<div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center mb-14 mb-md-18">
					<div class="col-lg-6 position-relative order-lg-2">
						...
						<div class="row gx-md-5 gy-5 position-relative">
							<div class="col-5">
								<img class="img-fluid rounded shadow-lg my-5 d-flex ms-auto" data-cue="fadeIn" data-delay="300" src="src/img/photos/sa9.jpg" srcset="src/img/photos/sa9@2x.jpg 2x" alt="" />
								<img class="img-fluid rounded shadow-lg d-flex col-10 ms-auto" data-cue="fadeIn" data-delay="600" src="src/img/photos/sa10.jpg" srcset="src/img/photos/sa10@2x.jpg 2x" alt="" />
							</div>
							<!-- /column -->
							<div class="col-7">
								<img class="img-fluid rounded shadow-lg mb-5" data-cue="fadeIn" data-delay="900" src="src/img/photos/sa11.jpg" srcset="src/img/photos/sa11@2x.jpg 2x" alt="" />
								<img class="img-fluid rounded shadow-lg d-flex col-11" data-cue="fadeIn" data-delay="1200" src="src/img/photos/sa12.jpg" srcset="src/img/photos/sa12@2x.jpg 2x" alt="" />
							</div>
							<!-- /column -->
						</div>
						<!-- /.row -->
				...
				<div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
					<div class="col-lg-6 position-relative">
						...
						<div class="row gx-md-5 gy-5 position-relative align-items-center">
							<div class="col-6">
								<img class="img-fluid rounded shadow-lg d-flex ms-auto" data-cue="fadeIn" data-delay="300" src="src/img/photos/sa13.jpg" srcset="src/img/photos/sa13@2x.jpg 2x" alt="" />
							</div>
							<!-- /column -->
							<div class="col-6">
								<img class="img-fluid rounded shadow-lg mb-5" data-cue="fadeIn" data-delay="900" src="src/img/photos/sa14.jpg" srcset="src/img/photos/sa14@2x.jpg 2x" alt="" />
								<img class="img-fluid rounded shadow-lg d-flex col-10" data-cue="fadeIn" data-delay="1200" src="src/img/photos/sa15.jpg" srcset="src/img/photos/sa15@2x.jpg 2x" alt="" />
							</div>
							<!-- /column -->
						</div>
						<!-- /.row -->
				...
				<div class="row text-center" data-cue="slideInUp">
					<div class="col-lg-10 mx-auto">
						<div class="mt-lg-n20 mt-xl-n22 position-relative">
							...
							<video poster="src/media/movie.jpg" class="player" playsinline controls preload="none">
								<source src="src/media/movie.mp4" type="video/mp4">
								<source src="src/media/movie.html" type="video/webm">
							</video>
						</div>
					</div>
					<!--/column -->
				...
				<div class="row text-center mt-12">
					<div class="col-lg-9 mx-auto">
						...
						<div class="row gx-lg-8 gx-xl-12 process-wrapper text-center mt-9" data-cues="slideInUp" data-group="process">
							<div class="col-md-4"> <img src="src/img/icons/shield.svg" class="svg-inject icon-svg icon-svg-md text-red mb-3" alt="" />
								<h4 class="mb-1">1. Secured Transactions</h4>
								<p>Etiam porta malesuada magna mollis euismod sem.</p>
							</div>
							<!--/column -->
							<div class="col-md-4"> <img src="src/img/icons/savings.svg" class="svg-inject icon-svg icon-svg-md text-green mb-3" alt="" />
								<h4 class="mb-1">2. Budget Planning</h4>
								<p>Etiam porta malesuada magna mollis euismod sem.</p>
							</div>
							<!--/column -->
							<div class="col-md-4"> <img src="src/img/icons/loading.svg" class="svg-inject icon-svg icon-svg-md text-yellow mb-3" alt="" />
					...
					<div class="col-lg-7 position-relative">
						...
						<div class="row gx-md-5 gy-5">
							<div class="col-md-6" data-cue="fadeIn">
								<figure class="rounded mt-md-10 position-relative"><img src="src/img/photos/g5.jpg" srcset="src/img/photos/g5@2x.jpg 2x" alt=""></figure>
							</div>
							<!--/column -->
							<div class="col-md-6">
								<div class="row gx-md-5 gy-5">
									<div class="col-md-12 order-md-2" data-cue="fadeIn" data-delay="900">
										<figure class="rounded"><img src="src/img/photos/g6.jpg" srcset="src/img/photos/g6@2x.jpg 2x" alt=""></figure>
									</div>
									<!--/column -->
					...
					<div class="row gy-6 mt-3 mt-md-5">
						<div class="col-md-6 col-lg-4">
							<div class="pricing card shadow-lg text-center">
								<div class="card-body">
									<img src="src/img/icons/shopping-basket.svg" class="svg-inject icon-svg icon-svg-md text-primary mb-3" alt="" />
						...
						<div class="col-md-6 col-lg-4 popular">
							<div class="pricing card shadow-lg text-center">
								<div class="card-body">
									<img src="src/img/icons/home.svg" class="svg-inject icon-svg icon-svg-md text-primary mb-3" alt="" />
						...
						<div class="col-md-6 offset-md-3 col-lg-4 offset-lg-0">
							<div class="pricing card shadow-lg text-center">
								<div class="card-body">
									<img src="src/img/icons/briefcase-2.svg" class="svg-inject icon-svg icon-svg-md text-primary mb-3" alt="" />
		...
		<!-- /section -->
		<section class="wrapper image-wrapper bg-auto no-overlay bg-image text-center bg-map" data-image-src="src/img/map.png">
