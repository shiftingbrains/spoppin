...
Website: https://SPOPPIN.org/
Support: https://SPOPPIN.org/support
Documentation: https://docs.SPOPPIN.org/
Extensions: https://SPOPPIN.org/extensions/
Email: support@SPOPPIN.org

== Description ==

SPOPPIN is the perfect theme for your project. Lightweight and highly extendable, it will enable you to create almost any type of website such a blog, portfolio, business website and WooCommerce storefront with a beautiful & professional design. Very fast, responsive, RTL & translation ready, best SEO practices, unique WooCommerce features to increase conversion and much more. You can even edit the settings on tablet & mobile so your site looks good on every device. Work with the most popular page builders as Elementor, Beaver Builder, Visual Composer, Divi, SiteOrigin, etc... Developers will love his extensible codebase making it a joy to customize and extend. Best friend of Elementor & WooCommerce. Looking for a Multi-Purpose theme? Look no further! Check the demos to realize that it's the only theme you will ever need: https://SPOPPIN.org/demos/
...
https://github.com/SPOPPIN/SPOPPIN/blob/master/changelog.md

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in SPOPPIN in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Navigate to Appearance > Customize in your admin panel and customize to taste.

== SPOPPIN Child Theme ==

There are multiple ways you can use a child theme with the SPOPPIN Theme, Use any one method mentioned below to create a child theme or use a child theme we have created.

1. Download the child theme from Github - https://github.com/SPOPPIN/SPOPPIN-child-theme
...
SPOPPIN is licensed under the GNU General Public License v2 or later
...
SPOPPIN WordPress Theme, Copyright 2021 SPOPPIN.org
SPOPPIN is distributed under the terms of the GNU GPL.
...
SPOPPIN bundles the following third-party resources:
